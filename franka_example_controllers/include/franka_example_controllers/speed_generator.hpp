...
/**
 * An example showing how to generate a joint pose motion at a specific velocity . Adapted from:
...
class SpeedGenerator {
 public:
  ...
  /**
   * Creates a new SpeedGenerator instance for a target q.
   *
